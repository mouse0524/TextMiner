...
set CGO_LDFLAGS=-L%CD%/lib/x86 -lonnxruntime -static-libgcc -static-libstdc++ %CD%/cmd/TextMiner/dll_bootstrap.o
set LDFLAGS=-s -w
...
set CGO_LDFLAGS=-L%CD%/lib/x64 -lonnxruntime -static-libgcc -static-libstdc++ %CD%/cmd/TextMiner/dll_bootstrap.o
set LDFLAGS=-s -w
...
REM Compile bootstrap C file
if exist %CD%/cmd/TextMiner/dll_bootstrap.o del /F /Q %CD%/cmd/TextMiner/dll_bootstrap.o >nul 2>&1
gcc -c %CD%/cmd/TextMiner/dll_bootstrap.c -o %CD%/cmd/TextMiner/dll_bootstrap.o -O2 -march=x86-64
if %ERRORLEVEL% NEQ 0 (
